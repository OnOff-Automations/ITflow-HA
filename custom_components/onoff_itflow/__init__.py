...
<div style="background-color: #f5f5f5; padding: 15px; border-radius: 4px; font-size: 12px; color: #666;">
    <h4 style="margin-top: 0; color: #333;">📍 Home Assistant Instance Information</h4>
    ...
    <p style="margin: 10px 0 0 0; font-style: italic;">
        🤖 This ticket was automatically generated by OnOff Support Agent
    </p>
</div>"""
        return footer_html
    ...
    try:
        ...
        for conf_key, (method_name, doc_name) in ({}.items() if True else doc_config.items()):
            ...
            try:
                ...
                _LOGGER.info("✅ Successfully updated ONLY document ID: %s", doc_id)
...
<h2 style="color: #4CAF50; border-bottom: 2px solid #4CAF50; padding-bottom: 10px;">✨ New Home Assistant Instance Detected</h2>

<div style="background-color: #e8f5e9; border-left: 4px solid #4CAF50; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #2e7d32;">📋 Instance Details</h3>
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
...
<div style="background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #856404;">🔐 Access Credentials</h3>
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
...
{get_ticket_footer(hass, entry)}
                ...
                await client.create_ticket(
                    subject="✨ New HA Instance Detected",
        ...
        if data.get(CONF_CREATE_STARTUP_TICKET, False) and data.get(CONF_INTEGRATION_MODE) != INTEGRATION_MODE_TICKETS_ONLY:
            try:
                ...
                ticket_details = f"""<div style="font-family: Arial, sans-serif; line-height: 1.6;">
<h2 style="color: #2196F3; border-bottom: 2px solid #2196F3; padding-bottom: 10px;">🔄 Home Assistant Restarted</h2>

<div style="background-color: #e3f2fd; border-left: 4px solid #2196F3; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #1565c0;">⏰ Restart Information</h3>
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
...
<div style="background-color: #f5f5f5; border-left: 4px solid #757575; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #424242;">💻 System Information</h3>
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
...
<div style="background-color: #e8f5e9; border-left: 4px solid #4CAF50; padding: 15px; margin: 15px 0;">
    <p style="margin: 0; color: #2e7d32;">✅ The system is now operational and all services have been restored.</p>
</div>
{get_ticket_footer(hass, entry)}
</div>"""

                response = await client.create_ticket(
                    subject=f"🔄 Home Assistant Restarted - {title}",
                    details=ticket_details,
                    priority="Low",
                    contact_id=hass.data[DOMAIN][entry.entry_id].get("itflow_contact_id"),
                    asset_id=hass.data[DOMAIN][entry.entry_id].get("itflow_asset_id"),
        ...
        if entry.data.get("first_installation"):
            try:
                ...
                ticket_details = f"""<div style="font-family: Arial, sans-serif; line-height: 1.6;">
<h2 style="color: #4CAF50; border-bottom: 2px solid #4CAF50; padding-bottom: 10px;">✅ OnOff Support Agent Installed Successfully!</h2>

<div style="background-color: #e8f5e9; border-left: 4px solid #4CAF50; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #2e7d32;">📊 Initial System Health Report</h3>
    <p>Your Home Assistant installation is now connected to OnOff Support Agent. Here's the initial system snapshot:</p>
</div>

<div style="background-color: #f5f5f5; border-left: 4px solid #757575; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #424242;">💻 System Resources</h3>
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
...
<div style="background-color: #e3f2fd; border-left: 4px solid #2196F3; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #1565c0;">🏠 Home Assistant Overview</h3>
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
...
{get_ticket_footer(hass, entry)}
                ...
                response = await client.create_ticket(
                    subject=f"✅ OnOff Support Agent Installed - {title}",
                    details=ticket_details,
                    priority="Low",
                    contact_id=hass.data[DOMAIN][entry.entry_id].get("itflow_contact_id"),
                    asset_id=hass.data[DOMAIN][entry.entry_id].get("itflow_asset_id"),
            ...
            if data.get(CONF_MONITOR_DISK, True):
                ...
                if disk.percent >= disk_threshold:
                    ...
                    if last_alerts["disk"] is None or (now - last_alerts["disk"]).total_seconds() > 3600:
                        ...
                        response = await client.create_ticket(
                            subject=f"⚠️ Low Disk Space Alert - {disk.percent}% Full",
                            details=f"""<div style="font-family: Arial, sans-serif; line-height: 1.6;">
<h2 style="color: #f44336; border-bottom: 2px solid #f44336; padding-bottom: 10px;">⚠️ Critical: Low Disk Space Alert</h2>

<div style="background-color: #ffebee; border-left: 4px solid #f44336; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #c62828;">🔴 Alert Information</h3>
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
...
<div style="background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #856404;">💾 Disk Usage Details</h3>
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
...
<div style="background-color: #ffcdd2; border-left: 4px solid #d32f2f; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #b71c1c;">⚡ Action Required</h3>
            ...
            if data.get(CONF_MONITOR_MEMORY, True):
                ...
                if memory.percent >= memory_threshold:
                    if last_alerts["memory"] is None or (now - last_alerts["memory"]).total_seconds() > 3600:
                        ...
                        response = await client.create_ticket(
                            subject=f"⚠️ High Memory Usage Alert - {memory.percent}% Used",
                            details=f"""<div style="font-family: Arial, sans-serif; line-height: 1.6;">
<h2 style="color: #ff9800; border-bottom: 2px solid #ff9800; padding-bottom: 10px;">⚠️ High Memory Usage Alert</h2>
...
<div style="background-color: #f5f5f5; border-left: 4px solid #757575; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #424242;">🧠 Memory Usage Details</h3>
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
            ...
            if data.get(CONF_MONITOR_CPU, True):
                ...
                if cpu_percent >= cpu_threshold:
                    if last_alerts["cpu"] is None or (now - last_alerts["cpu"]).total_seconds() > 3600:
                        ...
                        response = await client.create_ticket(
                            subject=f"⚠️ High CPU Usage Alert - {cpu_percent}% Used",
                            details=f"""<div style="font-family: Arial, sans-serif; line-height: 1.6;">
<h2 style="color: #ff5722; border-bottom: 2px solid #ff5722; padding-bottom: 10px;">⚠️ High CPU Usage Alert</h2>

<div style="background-color: #fbe9e7; border-left: 4px solid #ff5722; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #d84315;">🔶 Alert Information</h3>
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
            <td style="padding: 8px; font-weight: bold; width: 150px;">Alert Time:</td>
            <td style="padding: 8px;">{alert_time}</td>
...
<div style="background-color: #ffccbc; border-left: 4px solid #ff5722; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #bf360c;">⚡ Action Required</h3>
            ...
            if data.get(CONF_MONITOR_IP, True):
                try:
                    ...
                    if current_local_ip and last_ip.get("local") and current_local_ip != last_ip["local"]:
                        ...
                        await client.create_ticket(
                            subject=f"🔄 Local IP Address Changed",
                            details=f"""<div style="font-family: Arial, sans-serif; line-height: 1.6;">
<h2 style="color: #2196F3; border-bottom: 2px solid #2196F3; padding-bottom: 10px;">🔄 Local IP Address Changed</h2>

<div style="background-color: #e3f2fd; border-left: 4px solid #2196F3; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #1565c0;">📡 Network Change Detected</h3>
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
...
{get_ticket_footer(hass, entry)}
                    ...
                    try:
                        ...
                        if last_ip.get("public") and public_ip != last_ip["public"]:
                            ...
                            await client.create_ticket(
                                subject=f"🌐 Public IP Address Changed",
                                details=f"""<div style="font-family: Arial, sans-serif; line-height: 1.6;">
<h2 style="color: #673AB7; border-bottom: 2px solid #673AB7; padding-bottom: 10px;">🌐 Public IP Address Changed</h2>

<div style="background-color: #ede7f6; border-left: 4px solid #673AB7; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #4527A0;">🌍 Internet Connection Change Detected</h3>
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
            <td style="padding: 8px; font-weight: bold; width: 150px;">Change Time:</td>
            <td style="padding: 8px;">{change_time}</td>
...
{get_ticket_footer(hass, entry)}
            ...
            try:
                ...
                if not ping_success and last_alerts.get("ping_8888") is None:
                    response = await client.create_ticket(
                        subject=f"🔴 Internet Connectivity Lost - Ping to 8.8.8.8 Failed",
...
""",
    ...
    async def ha_started_listener(event_data):
        ...
        try:
            ...
            await client.create_ticket(
                subject=f"✅ Home Assistant Restarted",
    ...
    if entry.data.get(CONF_ALERT_ON_AUTOMATION_FAILURE):
        async def automation_failure_listener(event):
            ...
            try:
                ...
                client = hass.data[DOMAIN][entry.entry_id].get("itflow_client")
                if client:
                    ticket_subject = f"⚠️ Automation Failed: {automation_entity_id}"
                    ticket_details = f"""<div style="font-family: Arial, sans-serif; line-height: 1.6;">
...
<p style="color: #666; font-size: 12px; margin-top: 20px; padding-top: 10px; border-top: 1px solid #ddd;">
    🤖 This ticket was automatically generated by On-Off ITFlow integration
</p>
</div>"""
                    await client.create_ticket(
                    ...
                    if new_state and old_state and new_state.state != old_state.state:
                        ...
                        if latest_version != installed_version and latest_version != "Unknown":
                            ...
                            if client:
                                ...
                                ticket_subject = f"🔔 New Home Assistant Update Available: {latest_version}"
                                ticket_details = f"""<div style="font-family: Arial, sans-serif; line-height: 1.6;">
<h2 style="color: #03a9f4; border-bottom: 2px solid #03a9f4; padding-bottom: 10px;">🎉 New Home Assistant Update Available</h2>

<div style="background-color: #e3f2fd; border-left: 4px solid #03a9f4; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #01579b;">📦 Version Information</h3>
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
...
<div style="background-color: #fff; border: 1px solid #03a9f4; border-radius: 4px; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #03a9f4;">📝 Release Notes</h3>
...
<div style="background-color: #fff9c4; border-left: 4px solid #fbc02d; padding: 15px; margin: 15px 0;">
    <p style="margin: 0;"><strong>📅 Action Required:</strong> Please review and schedule the update at your earliest convenience.</p>
</div>
...
<h2 style="color: #2196F3; border-bottom: 2px solid #2196F3; padding-bottom: 10px;">📋 Support Ticket</h2>

<div style="background-color: #f5f5f5; border-left: 4px solid #2196F3; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #1565c0;">📝 Ticket Details</h3>
    <div style="background-color: #fff; padding: 12px; border-radius: 4px;">
        {details.replace(chr(10), '<br>')}
            ...
            if email or phone or user_name != "Unknown User":
                details_html += f"""
<div style="background-color: #e3f2fd; border-left: 4px solid #03a9f4; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #01579b;">👤 Contact Information</h3>
    <table style="width: 100%; border-collapse: collapse;">"""
        ...
        <tr>
            ...
            if "🤖 This ticket was automatically generated" not in details:
...
<div style="background-color: #fff; padding: 12px; border-radius: 4px;">
    {reply_text.replace(chr(10), '<br>')}
        ...
        try:
            ...
            if response.get("success"):
                _LOGGER.info("✓ Successfully added reply to ticket #%s", ticket_id)
            else:
                error_msg = response.get("message", "Unknown error")
                _LOGGER.error("✗ Failed to add reply to ticket: %s", error_msg)
                raise Exception(f"ITFlow API error: {error_msg}")
        except Exception as err:
            _LOGGER.error("✗ Error adding reply to ticket: %s", err, exc_info=True)
            raise
...
<div style="background-color: {'#e8f5e9' if health_status == 'Healthy' else '#fff3e0' if health_status == 'Warning' else '#ffebee'}; border-left: 4px solid {health_color}; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: {health_color};">📊 Overall Health Status</h3>
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
...
<div style="background-color: #e1f5fe; border-left: 4px solid #039be5; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #01579b;">⏱️ Uptime & Network Information</h3>
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
...
<div style="background-color: #f3e5f5; border-left: 4px solid #9c27b0; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #6a1b9a;">🌐 Ping Results</h3>
    <table style="width: 100%; border-collapse: collapse;">"""
...
<div style="background-color: #e3f2fd; border-left: 4px solid #2196F3; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #1565c0;">🏠 Home Assistant Details</h3>
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
...
<div style="background-color: #f3e5f5; border-left: 4px solid #9c27b0; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #6a1b9a;">📈 Top 5 Entity Domains</h3>
    <table style="width: 100%; border-collapse: collapse;">"""
        ...
        try:
            ...
            if cloud_backup:
                if cloud_backup.state == 'on':
                    backup_status['Home Assistant Cloud'] = "✅ Active"
                    ...
                    backup_status['Home Assistant Cloud'] = "❌ No Recent Backups"
                    backup_issues.append("Home Assistant Cloud has no recent backups")
                    overall_backup_status = "Warning"
                    backup_color = "#ff9800"
                    backup_icon = "🟠"
            else:
                backup_status['Home Assistant Cloud'] = "⚠️ Not Configured"
            ...
            if google_backup_sensor:
                ...
                if state not in ['unknown', 'unavailable', 'Unknown']:
                    backup_status['Google Drive Backup'] = f"✅ {google_backup_sensor.attributes.get('friendly_name', 'Active')}"
                    backup_status['Google Drive Details'] = f"Status: {state}"
                else:
                    backup_status['Google Drive Backup'] = "❌ Issue Detected"
                    backup_issues.append("Google Drive Backup shows unknown/unavailable status")
                    overall_backup_status = "Warning"
                    backup_color = "#ff9800"
                    backup_icon = "🟠"
            else:
                backup_status['Google Drive Backup'] = "⚠️ Not Configured"
            ...
            if local_backup_count > 0:
                backup_status['Local Backups'] = f"✅ {local_backup_count} backups found"
            else:
                backup_status['Local Backups'] = "⚠️ No local backups detected"
            ...
            # Create HTML report
            ticket_subject = f"🔄 Backup Status Report - {title}"
            ticket_details = f"""<div style="font-family: Arial, sans-serif; line-height: 1.6;">
...
<div style="background-color: {'#e8f5e9' if overall_backup_status == 'Healthy' else '#fff3e0'}; border-left: 4px solid {backup_color}; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: {backup_color};">📊 Overall Backup Status</h3>
    <table style="width: 100%; border-collapse: collapse;">
        <tr>
            <td style="padding: 8px; font-weight: bold; width: 150px;">Status:</td>
        ...
        <tr>
            ...
            if backup_issues:
                ticket_details += f"""
<div style="background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #856404;">⚠️ Backup Issues Detected</h3>
    <ul style="margin: 10px 0 0 0; padding-left: 20px;">"""
            ...
            ticket_details += f"""
<div style="background-color: #f5f5f5; border-left: 4px solid #757575; padding: 15px; margin: 15px 0;">
    <h3 style="margin-top: 0; color: #424242;">💾 Backup Systems Status</h3>
    <table style="width: 100%; border-collapse: collapse;">"""
